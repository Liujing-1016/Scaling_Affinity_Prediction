...
train_file = "../data/processed/train_target_1.parquet"
test_smiles = "../data/raw/test_smiles.csv"
model_dir = "../data/models/XGBoost"
output_file = "../data/results/predictions_XGB/all_predictions_xgb_3.parquet"
...
X_train = pd.read_parquet("../data/processed/X_ecfp_train.parquet")
X_test = pd.read_parquet("../data/processed/XGBoost/X_ecfp_test.parquet")
